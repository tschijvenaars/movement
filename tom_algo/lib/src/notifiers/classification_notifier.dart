import 'package:movement_algo/src/data/sensor_data_repository.dart';
import 'package:movement_algo/src/models/sensor_data.dart';
import 'package:movement_algo/src/notifiers/classifiers/stop_classifier.dart';

import 'classifiers/noise_classifier.dart';
...
class ClassificationNotifier {
  ...
  void classify(SensorData sensorData) async {

...
final appThemeData = {
  AppTheme.StandardTheme: ThemeData(
    ...
    primaryTextTheme: const TextTheme(
      headline1: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: ColorPallet.darkTextColor),
      bodyText1: TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: ColorPallet.midGray),
    ),
